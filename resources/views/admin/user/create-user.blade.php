<x-app-layout>
    ...
    <div class="px-4 md:px-4 lg:px-8 container mx-auto">
        ...
        <div class="flex flex-col pb-24" x-data="{ imageUrl: '/noimage.png' }">
                ...
                <div class="w-full lg:w-1/2 mx-auto">
                    ...
                    <div class="mt-6">
                        ...
                        <select id="role" name="role"
                            ...
                            <option value="admin" {{ old('role') == 'admin' ? 'selected' : '' }}>Aktif</option>
                        </select>
                        <p class="text-sm italic mt-2 text-black/60">default is 'user'</p>
                    </div>
