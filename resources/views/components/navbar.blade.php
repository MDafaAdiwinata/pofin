  <nav data-aos="fade-down" data-aos-duration="1000" data-aos-delay="2000" id="navbar"
      ...
      <div class="max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl flex flex-wrap items-center justify-between mx-auto p-8 transition-all duration-300 ease-in-out"
          ...
          <!-- Tombol (DESKTOP) -->
          @if (Route::has('login'))
              <div class="hidden lg:flex lg:order-2 space-x-2 rtl:space-x-reverse">
                  @auth
          ...
          <div class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1" id="navbar-cta">
              <ul
                  ...
                  <li>
                      <a href="/"
                          class="text-center lg:text-start mb-3 lg:mb-0 block py-2 px-3 lg:p-0 text-[#1a1a1a] rounded-lg lg:bg-transparent lg:text-[#000]/80">
                          Beranda
                      </a>
                  </li>
                  <li>
                  ...
                  <li class="block lg:hidden mt-4 space-y-3">
                      @auth
                          <a href="{{ route('dashboard') }}"
                              class="w-full flex items-center justify-center text-[#000]/60 border border-[#000]/30 font-bold bg-[#475449]/10 rounded-xl text-md px-4 py-2 text-center hover:bg-[#000]/10 hover:cursor-pointer transition">
                              Dashboard
                          </a>
                      @else
                          @if (Route::has('register'))
